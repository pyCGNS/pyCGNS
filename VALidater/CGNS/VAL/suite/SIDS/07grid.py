...
g=CGL.newGridCoordinates(z,'{Grid#001}')
d=CGL.newDataArray(g,CGK.CoordinateX_s,NPY.ones((5,),dtype='d',order='F'))
g=CGL.newGridCoordinates(z,'{Grid#002}')
d=CGL.newDataArray(g,CGK.CoordinateR_s,NPY.ones((5,),dtype='d',order='F'))
g=CGL.newGridCoordinates(z,'{Grid#003}')
d=CGL.newDataArray(g,CGK.CoordinateXi_s,NPY.ones((5,),dtype='d',order='F'))
...
g=CGL.newGridCoordinates(z,'{Grid#002}')
d=CGL.newDataArray(g,CGK.CoordinateXi_s,NPY.ones((5,7),dtype='d',order='F'))
d=CGL.newDataArray(g,CGK.CoordinateEta_s,NPY.ones((5,7),dtype='d',order='F'))
TESTS.append((tag,T,diag))
...
z=CGL.newZone(b,'{Zone}',NPY.array([[5,4,0],[7,6,0],[9,8,0]],order='F'))
g=CGL.newGridCoordinates(z,'{Grid#001}')
d=CGL.newDataArray(g,CGK.CoordinateX_s,NPY.ones((4,7,9),dtype='d',order='F'))
d=CGL.newDataArray(g,CGK.CoordinateY_s,NPY.ones((5,7,9),dtype='d',order='F'))
d=CGL.newDataArray(g,CGK.CoordinateZ_s,NPY.ones((5,7,9),dtype='d',order='F'))
TESTS.append((tag,T,diag))
