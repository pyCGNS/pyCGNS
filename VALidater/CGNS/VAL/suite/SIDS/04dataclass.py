...
w=CGL.newDataArray(g,CGK.CoordinateX_s,NPY.ones((5,7,9),dtype='d',order='F'))
w=CGL.newDataArray(g,CGK.CoordinateY_s,NPY.ones((5,7,9),dtype='d',order='F'))
w=CGL.newDataArray(g,CGK.CoordinateZ_s,NPY.ones((5,7,9),dtype='d',order='F'))
...
a=CGL.newDataArray(f,'{DataArray}')
...
x=CGL.newGridConnectivity(z,'{GridConnectivity}',z[0])
