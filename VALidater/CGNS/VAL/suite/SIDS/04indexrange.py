...
def makeCorrectTree(vertexsize,cellsize):
  ...
  d=CGL.newDataArray(g,CGK.CoordinateX_s,
                     NPY.ones((vertexsize),dtype='d',order='F'))
...
CGU.newNode(CGK.PointRange_s,
            NPY.array([[cellsize+1,cellsize+ntris+1]],dtype=NPY.int32,order='F'),[],CGK.IndexRange_ts,parent=n)
TESTS.append((tag,T,diag))
