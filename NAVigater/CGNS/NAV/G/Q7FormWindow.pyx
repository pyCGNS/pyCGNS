...
#
# Created: Wed Jan  4 13:36:30 2012
...
class Ui_Q7FormWindow(object):
    def setupUi(self, Q7FormWindow):
        ...
        self.cDataType.setGeometry(QtCore.QRect(49, 9, 81, 20))
        self.cDataType.setObjectName("cDataType")
        self.eDims = QtGui.QLineEdit(self.tData)
        self.eDims.setGeometry(QtCore.QRect(136, 9, 127, 20))
        self.eDims.setObjectName("eDims")
        self.line = QtGui.QFrame(self.tData)
        self.line.setGeometry(QtCore.QRect(260, 9, 16, 46))
        self.line.setFrameShape(QtGui.QFrame.VLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName("line")
        self.groupBox = QtGui.QGroupBox(self.tData)
        self.groupBox.setGeometry(QtCore.QRect(280, 0, 201, 31))
        self.groupBox.setObjectName("groupBox")
        self.radioButton = QtGui.QRadioButton(self.groupBox)
        self.radioButton.setGeometry(QtCore.QRect(40, 10, 104, 22))
        self.radioButton.setChecked(True)
        self.radioButton.setObjectName("radioButton")
        self.radioButton_2 = QtGui.QRadioButton(self.groupBox)
        self.radioButton_2.setGeometry(QtCore.QRect(100, 10, 104, 22))
        self.radioButton_2.setObjectName("radioButton_2")
        self.radioButton_3 = QtGui.QRadioButton(self.groupBox)
        self.radioButton_3.setGeometry(QtCore.QRect(150, 10, 104, 22))
        ...
        self.eItems.setGeometry(QtCore.QRect(49, 35, 127, 20))
        self.eItems.setObjectName("eItems")
        self.label_7 = QtGui.QLabel(self.tData)
        self.label_7.setGeometry(QtCore.QRect(278, 35, 29, 16))
        self.label_7.setObjectName("label_7")
        self.eNodeSize = QtGui.QLineEdit(self.tData)
        self.eNodeSize.setGeometry(QtCore.QRect(313, 35, 161, 20))
        self.eNodeSize.setObjectName("eNodeSize")
        self.label_22 = QtGui.QLabel(self.tData)
        self.label_22.setGeometry(QtCore.QRect(10, 430, 47, 16))
        self.label_22.setObjectName("label_22")
        self.cShowAs = QtGui.QComboBox(self.tData)
        self.cShowAs.setGeometry(QtCore.QRect(70, 430, 111, 20))
        self.cShowAs.setObjectName("cShowAs")
        self.spinBox_3 = QtGui.QSpinBox(self.tData)
        self.spinBox_3.setGeometry(QtCore.QRect(340, 430, 37, 20))
        self.spinBox_3.setObjectName("spinBox_3")
        self.spinBox_2 = QtGui.QSpinBox(self.tData)
        self.spinBox_2.setGeometry(QtCore.QRect(440, 430, 37, 20))
        ...
        self.label_24.setGeometry(QtCore.QRect(190, 430, 47, 16))
        self.label_24.setObjectName("label_24")
        self.cPlane = QtGui.QComboBox(self.tData)
        self.cPlane.setGeometry(QtCore.QRect(230, 430, 71, 20))
        self.cPlane.setObjectName("cPlane")
        self.label_30 = QtGui.QLabel(self.tData)
        self.label_30.setGeometry(QtCore.QRect(310, 430, 47, 16))
        self.label_30.setObjectName("label_30")
        self.label_31 = QtGui.QLabel(self.tData)
        self.label_31.setGeometry(QtCore.QRect(390, 430, 47, 16))
    ...
    def retranslateUi(self, Q7FormWindow):
        ...
        self.label_30.setText(QtGui.QApplication.translate("Q7FormWindow", "Col", None, QtGui.QApplication.UnicodeUTF8))
        self.label_31.setText(QtGui.QApplication.translate("Q7FormWindow", "Row", None, QtGui.QApplication.UnicodeUTF8))
