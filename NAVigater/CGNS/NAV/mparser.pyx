...
class Mesh(CGNSparser):
  ...
  def __init__(self,T):
    ...
    self._vtkelts={CGK.TRI_3:   (vtk.vtkTriangle,(3,3)),
                   ...
                   12:(vtk.vtkPyramid(),(5,5)),
                   13:(vtk.vtkPyramid(),(5,14)),
                   14:(vtk.vtkPolyhedron(),(6,6)),
                   15:(vtk.vtkPolyhedron(),(6,15)),
                   16:(vtk.vtkPolyhedron(),(6,18)),
                   17:(vtk.vtkHexahedron(),(8,8)),
                   18:(vtk.vtkHexahedron(),(8,20)),
                   19:(vtk.vtkHexahedron(),(8,27))}
    self.parseZones()
