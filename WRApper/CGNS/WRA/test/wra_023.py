...
print 'CGNS.WRA.mll','#023 - descriptor_write'
...
a=Mll.pyCGNS('tmp/testmll23.hdf',Mll.MODE_WRITE)
...
a.gopath('/Base')
a.integral_write('IntegralData #1')
a.integral_write('IntegralData #2')
a.integral_write('IntegralData #3')
a.descriptor_write('descriptor #1','bla bla bla bla bla text')
a.descriptor_write('descriptor #2','bla text bla bla')
a.close()
