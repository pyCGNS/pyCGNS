...
a.conn_write(1,1,'Connectivity',3,3,4,2,N.array([[3,1,1],[3,5,7]]),'Zone 02',2,0,0,0,N.array([[1,1,1],[1,5,7]]))
a.conn_periodic_write(1,1,1,N.array([1.1,2.2,3.3]),N.array([3.3,2.2,1.1]),N.array([1.5,2.6,3.7]))
