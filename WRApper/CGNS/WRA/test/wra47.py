...
a._1to1_write(1,1,'Connectivity','Zone2',N.array([[3,1,1],[3,5,7]]),N.array([[1,1,1],[1,5,7]]),N.array([1,2,3]))
a._1to1_periodic_write(1,1,1,N.array([1.1,2.2,3.3]),N.array([3.3,2.2,1.1]),N.array([1.5,2.6,3.7]))
