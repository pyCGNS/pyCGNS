...
a=Mll.pyCGNS('tmp/testmll27.hdf',Mll.MODE_WRITE)
...
a.expfull_write(3,N.array([2,2,2,2,2,2,2,2]))
a.gopath('/Base/Zone 01/GridCoordinates/CoordinateY')
a.expfull_write(4,N.array([2,2,2,2,2,2,2,2]))
a.gopath('/Base/Zone 01/GridCoordinates/CoordinateZ')
a.expfull_write(4,N.array([2,2,2,2]))
a.gopath('/Base/Zone 02/GridCoordinates/CoordinateX')
a.expfull_write(6,N.array([2,2,2,2,2,2,2,2]))
a.close()
