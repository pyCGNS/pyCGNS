...
a=Mll.pyCGNS('tmp/testmll33.hdf',Mll.MODE_WRITE)
...
t=a.field_write(1,1,1,2,'data array3',N.ones((2,4,6)))
## a.field_write(1,1,1,5,'data array4',N.ones((2,4,6))*1.2)
## p=a.field_partial_write(1,2,1,3,'data partial array',N.array([1,1,1]),N.array([2,3,3]),N.ones((2,4,6))*18.2)

p=a.sol_ptset_write(1,1,'sol ptset',3,4,2,N.array([[1,1,1],[1,2,2]]))
print p
