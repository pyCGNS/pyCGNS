...
print 'CGNS.WRA.mll','#047 - conn_1to1_periodic_write'
...
a=Mll.pyCGNS('tmp/testmll47.hdf',Mll.MODE_WRITE)
...
a.conn_1to1_write(1,1,'Connectivity','Zone2',NPY.array([[3,1,1],[3,5,7]]),NPY.array([[1,1,1],[1,5,7]]),NPY.array([1,2,3]))
a.conn_1to1_periodic_write(1,1,1,NPY.array([1.1,2.2,3.3]),NPY.array([3.3,2.2,1.1]),NPY.array([1.5,2.6,3.7]))
