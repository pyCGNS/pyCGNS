...
# ------------------------------------------------------------
# $Id: connect.py 108 2003-11-13 15:29:58Z mpoinot $
#
...
"""
  ...
  def __import(self,fileid,pathid,compress):
    ...
    for fte in ft:
        ...
        r=self._db.runSQL(stmt)
        if (r): mode=dxModeUpdateCheckin
        else:   mode=dxModeCreateCheckin
