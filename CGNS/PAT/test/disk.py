...
T = ['CGNSTree', None, [
    ...
    ['{Base#1}', numpy.array([3, 3], dtype='i', order='C'), [
        ...
        ['{Zone-A}', numpy.array([[13, 12, 0], [61, 60, 0], [17, 16, 0]], dtype='l', order='F'), [
            ...
            ['ZoneBC', None, [
                ...
                ['{BC-4}',
                 numpy.array(['F', 'a', 'm', 'i', 'l', 'y', 'S', 'p', 'e', 'c', 'i', 'f', 'i', 'e', 'd'], dtype='S',
                             order='C'), [
                     ['PointRange', numpy.array([[1, 13], [61, 61], [1, 17]], dtype='i', order='F'), [],
                      'IndexRange_t'],
                     ['FamilyName', numpy.array(['E', 'x', 't', 'e', 'r', 'i', 'o', 'r'], dtype='S', order='C'), [],
                      'FamilyName_t'], ], 'BC_t'],
                ['{BC-6}',
                 numpy.array(['F', 'a', 'm', 'i', 'l', 'y', 'S', 'p', 'e', 'c', 'i', 'f', 'i', 'e', 'd'], dtype='S',
                             order='C'), [
                     ['PointRange', numpy.array([[1, 13], [1, 61], [17, 17]], dtype='i', order='F'), [],
                      'IndexRange_t'],
                     ['FamilyName', numpy.array(['E', 'x', 't', 'e', 'r', 'i', 'o', 'r'], dtype='S', order='C'), [],
            ...
            ['ZoneGridConnectivity', None, [
                ...
                ['{CT-A-B}', numpy.array(['{', 'Z', 'o', 'n', 'e', '-', 'B', '}'], dtype='S', order='C'), [
                    ...
                    ['PointRangeDonor', numpy.array([[1, 1], [1, 61], [1, 17]], dtype='i', order='F'), [],
        ...
        ['{Zone-B}', numpy.array([[31, 30, 0], [61, 60, 0], [17, 16, 0]], dtype='l', order='F'), [
            ...
            ['ZoneBC', None, [
                ...
                ['{BC-4}',
                 numpy.array(['F', 'a', 'm', 'i', 'l', 'y', 'S', 'p', 'e', 'c', 'i', 'f', 'i', 'e', 'd'], dtype='S',
                             order='C'), [
                     ['PointRange', numpy.array([[1, 31], [61, 61], [1, 17]], dtype='i', order='F'), [],
                      'IndexRange_t'],
                     ['FamilyName', numpy.array(['E', 'x', 't', 'e', 'r', 'i', 'o', 'r'], dtype='S', order='C'), [],
                      'FamilyName_t'], ], 'BC_t'],
                ['{BC-6}',
                 numpy.array(['F', 'a', 'm', 'i', 'l', 'y', 'S', 'p', 'e', 'c', 'i', 'f', 'i', 'e', 'd'], dtype='S',
                             order='C'), [
                     ['PointRange', numpy.array([[1, 31], [1, 61], [17, 17]], dtype='i', order='F'), [],
                      'IndexRange_t'],
                     ['FamilyName', numpy.array(['E', 'x', 't', 'e', 'r', 'i', 'o', 'r'], dtype='S', order='C'), [],
                      'FamilyName_t'], ], 'BC_t'], ], 'ZoneBC_t'],
            ['ZoneGridConnectivity', None, [
                ['{CT-B-A}', numpy.array(['{', 'Z', 'o', 'n', 'e', '-', 'A', '}'], dtype='S', order='C'), [
                    ['Transform', numpy.array([1, 2, 3], dtype='i', order='C'), [], '"int[IndexDimension]"'],
                    ['PointRange', numpy.array([[1, 1], [1, 61], [1, 17]], dtype='i', order='F'), [], 'IndexRange_t'],
                    ['PointRangeDonor', numpy.array([[13, 13], [1, 61], [1, 17]], dtype='i', order='F'), [],
        ...
        ['{Zone-C1}', numpy.array([[27, 26, 0], [25, 24, 0], [17, 16, 0]], dtype='l', order='F'), [
            ...
            ['ZoneBC', None, [
                ...
                ['{BC-4}',
                 numpy.array(['F', 'a', 'm', 'i', 'l', 'y', 'S', 'p', 'e', 'c', 'i', 'f', 'i', 'e', 'd'], dtype='S',
                             order='C'), [
                     ['PointRange', numpy.array([[1, 27], [25, 25], [1, 17]], dtype='i', order='F'), [],
                      'IndexRange_t'],
                     ['FamilyName', numpy.array(['E', 'x', 't', 'e', 'r', 'i', 'o', 'r'], dtype='S', order='C'), [],
                      'FamilyName_t'], ], 'BC_t'],
                ['{BC-6}',
                 numpy.array(['F', 'a', 'm', 'i', 'l', 'y', 'S', 'p', 'e', 'c', 'i', 'f', 'i', 'e', 'd'], dtype='S',
                             order='C'), [
                     ['PointRange', numpy.array([[1, 27], [1, 25], [17, 17]], dtype='i', order='F'), [],
                      'IndexRange_t'],
                     ['FamilyName', numpy.array(['E', 'x', 't', 'e', 'r', 'i', 'o', 'r'], dtype='S', order='C'), [],
                      'FamilyName_t'], ], 'BC_t'], ], 'ZoneBC_t'],
            ['ZoneGridConnectivity', None, [
                ['{CT-C1-C2}', numpy.array(['{', 'Z', 'o', 'n', 'e', '-', 'C', '2', '}'], dtype='S', order='C'), [
                    ...
                    ['PointRangeDonor', numpy.array([[1, 27], [37, 37], [1, 17]], dtype='i', order='F'), [],
                     'IndexRange_t'], ], 'GridConnectivity1to1_t'],
        ...
        ['{Zone-C2}', numpy.array([[27, 26, 0], [37, 36, 0], [17, 16, 0]], dtype='l', order='F'), [
            ...
            ['ZoneBC', None, [
                ...
                ['{BC-6}',
                 numpy.array(['F', 'a', 'm', 'i', 'l', 'y', 'S', 'p', 'e', 'c', 'i', 'f', 'i', 'e', 'd'], dtype='S',
                             order='C'), [
                     ['PointRange', numpy.array([[1, 27], [1, 37], [17, 17]], dtype='i', order='F'), [],
                      'IndexRange_t'],
                     ['FamilyName', numpy.array(['E', 'x', 't', 'e', 'r', 'i', 'o', 'r'], dtype='S', order='C'), [],
                      'FamilyName_t'], ], 'BC_t'], ], 'ZoneBC_t'],
            ['ZoneGridConnectivity', None, [
                ...
                ['{CT-C2-C1}', numpy.array(['{', 'Z', 'o', 'n', 'e', '-', 'C', '1', '}'], dtype='S', order='C'), [
                    ...
                    ['PointRangeDonor', numpy.array([[1, 27], [1, 1], [1, 17]], dtype='i', order='F'), [],
                     'IndexRange_t'], ], 'GridConnectivity1to1_t'], ], 'ZoneGridConnectivity_t'],
            ['FlowSolution#EndOfRun', None, [
                ['GridLocation', numpy.array(['C', 'e', 'l', 'l', 'C', 'e', 'n', 't', 'e', 'r'], dtype='S', order='C'),
                 [], 'GridLocation_t'],
        ...
        ['{Zone-D1}', numpy.array([[41, 40, 0], [61, 60, 0], [17, 16, 0]], dtype='l', order='F'), [
            ...
            ['ZoneBC', None, [
                ...
                ['{BC-4}',
                 numpy.array(['F', 'a', 'm', 'i', 'l', 'y', 'S', 'p', 'e', 'c', 'i', 'f', 'i', 'e', 'd'], dtype='S',
                             order='C'), [
                     ['PointRange', numpy.array([[1, 41], [61, 61], [1, 17]], dtype='i', order='F'), [],
                      'IndexRange_t'],
                     ['FamilyName', numpy.array(['E', 'x', 't', 'e', 'r', 'i', 'o', 'r'], dtype='S', order='C'), [],
                      'FamilyName_t'], ], 'BC_t'],
                ['{BC-6}',
                 numpy.array(['F', 'a', 'm', 'i', 'l', 'y', 'S', 'p', 'e', 'c', 'i', 'f', 'i', 'e', 'd'], dtype='S',
                             order='C'), [
                     ['PointRange', numpy.array([[1, 41], [1, 61], [17, 17]], dtype='i', order='F'), [],
                      'IndexRange_t'],
                     ['FamilyName', numpy.array(['E', 'x', 't', 'e', 'r', 'i', 'o', 'r'], dtype='S', order='C'), [],
                      'FamilyName_t'], ], 'BC_t'], ], 'ZoneBC_t'],
            ['ZoneGridConnectivity', None, [
                ...
                ['{CT-D1-D2}', numpy.array(['{', 'Z', 'o', 'n', 'e', '-', 'D', '2', '}'], dtype='S', order='C'), [
                    ...
                    ['PointRangeDonor', numpy.array([[1, 41], [1, 61], [17, 17]], dtype='i', order='F'), [],
                     'IndexRange_t'], ], 'GridConnectivity1to1_t'], ], 'ZoneGridConnectivity_t'],
            ['FlowSolution#EndOfRun', None, [
                ['GridLocation', numpy.array(['C', 'e', 'l', 'l', 'C', 'e', 'n', 't', 'e', 'r'], dtype='S', order='C'),
                 [], 'GridLocation_t'],
        ...
        ['{Zone-D2}', numpy.array([[41, 40, 0], [61, 60, 0], [17, 16, 0]], dtype='l', order='F'), [
            ...
            ['ZoneGridConnectivity', None, [
                ...
                ['{CT-D2-D1}', numpy.array(['{', 'Z', 'o', 'n', 'e', '-', 'D', '1', '}'], dtype='S', order='C'), [
                    ...
                    ['PointRangeDonor', numpy.array([[1, 41], [1, 61], [1, 1]], dtype='i', order='F'), [],
                     'IndexRange_t'], ], 'GridConnectivity1to1_t'],
        ...
        ['ReferenceState', None, [
            ...
            ['VelocityMagnitude', numpy.array([68.0525297105], dtype='d', order='C'), [], 'DataArray_t'], ],
         'ReferenceState_t'],
        ['.Solver#Compute', None, [
