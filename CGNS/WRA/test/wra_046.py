...
print('CGNS.WRA.mll', '#046 - conn_periodic_write')
...
a = Mll.pyCGNS('tmp/testmll46.hdf', Mll.MODE_WRITE)
...
a.conn_write(1, 1, 'Connectivity', 3, 3, 4, 2, NPY.array([[3, 1, 1], [3, 5, 7]]), 'Zone 02', 2, 0, 0, 0,
             NPY.array([[1, 1, 1], [1, 5, 7]]))
a.conn_periodic_write(1, 1, 1, NPY.array([1.1, 2.2, 3.3]), NPY.array([3.3, 2.2, 1.1]), NPY.array([1.5, 2.6, 3.7]))
