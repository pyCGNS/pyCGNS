...
print('CGNS.WRA.mll', '#014 - discrete_ptset_write')
...
a.boco_normal_write(1, 1, 1, NPY.array([0, 1, 0]), 1, 3, NPY.array([[0.5, 0.3, 0.2],
                                                                    [0.5, 0.3, 0.2],
                                                                    [0.5, 0.3, 0.2],
                                                                    [0.5, 0.3, 0.2],
                                                                    [0.5, 0.3, 0.2],
...
## a.boco_normal_write(1,1,2,NPY.array([0,1,0]),0,3,NPY.array([0.5]))
a.boco_normal_write(1, 1, 2, NPY.array([0, 1, 0]), 0)
a.boco_gridlocation_write(1, 1, 1, 2)
a.dataset_write(1, 1, 1, "dataset", 5)
a.gopath('/Base/Zone 01/GridCoordinates')
a.user_data_write('user_data')
a.discrete_write(1, 1, 'discrete')
a.discrete_write(1, 1, 'discrete2')
a.discrete_ptset_write(1, 1, 'ptset', 3, 2, 2, NPY.array([[1, 1], [1, 2]]))
