...
print 'CGNS.WRA.mll','#052 - link_write'
...
a=Mll.pyCGNS('tmp/testmll52.hdf',Mll.MODE_WRITE)
...
a.link_write('GridCoordinates','tmp/testmll51.hdf','/Base/Zone 02/GridCoordinates')
a.close()
