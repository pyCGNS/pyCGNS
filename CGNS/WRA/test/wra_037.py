...
print('CGNS.WRA.mll', '#037 - arbitrary_motion_write')
...
a = Mll.pyCGNS('tmp/testmll37.hdf', Mll.MODE_WRITE)
...
a.field_write(1, 1, 1, 3, 'data array', NPY.ones((2, 4, 6)) * 1.2)
a.arbitrary_motion_write(1, 1, 'motion #1', 3)
p = a.arbitrary_motion_write(1, 1, 'motion #2', 2)
a.close()
