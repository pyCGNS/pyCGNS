...
print('CGNS.WRA.mll', '#009 - gopath/bcdataset_write/bcdataset_info/bcdataset_read')
...
a = Mll.pyCGNS('tmp/testmll09.hdf', Mll.MODE_WRITE)
...
a.gopath('/Base/Zone 01/BC')
a.bcdataset_write("datasetl", 12, 3)
a.gopath('/Base/Zone 01/BC')
n = a.bcdataset_info()
