...
#
# Created: Tue Feb 16 18:03:07 2016
...
class Ui_Q7ToolsWindow(object):
    def setupUi(self, Q7ToolsWindow):
        ...
        self.bApply.setGeometry(QtCore.QRect(480, 55, 25, 25))
        self.bApply.setMinimumSize(QtCore.QSize(25, 25))
        self.bApply.setMaximumSize(QtCore.QSize(25, 25))
        self.bApply.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/images/icons/operate-execute.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bApply.setIcon(icon2)
        self.bApply.setObjectName("bApply")
        self.spinBox = QtGui.QSpinBox(self.Queries)
        self.spinBox.setGeometry(QtCore.QRect(190, 240, 53, 22))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/images/icons/flag-none.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Q7ToolsWindow):
        ...
        self.checkBox.setText(QtGui.QApplication.translate("Q7ToolsWindow", "Show predefined query #", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_2.setTitle(QtGui.QApplication.translate("Q7ToolsWindow", "Query arguments :", None, QtGui.QApplication.UnicodeUTF8))
        self.radioButton.setText(QtGui.QApplication.translate("Q7ToolsWindow", "Use last selected value as arg", None, QtGui.QApplication.UnicodeUTF8))
        self.radioButton_2.setText(QtGui.QApplication.translate("Q7ToolsWindow", "Plain value", None, QtGui.QApplication.UnicodeUTF8))
        self.radioButton_3.setText(QtGui.QApplication.translate("Q7ToolsWindow", "Regexp value", None, QtGui.QApplication.UnicodeUTF8))
        self.radioButton_4.setText(QtGui.QApplication.translate("Q7ToolsWindow", "Use ALL selected value as arg (loop on values and add selections)", None, QtGui.QApplication.UnicodeUTF8))
