...
#
# Created: Fri Mar 11 10:06:33 2016
...
class Ui_Q7VTKWindow(object):
    def setupUi(self, Q7VTKWindow):
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/images/icons/flag-bwd.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/images/icons/flag-fwd.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bUpdateFromTree.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/images/icons/flag-revert.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/images/icons/top.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bBackControl.setIcon(icon18)
        ...
        self.bInfo.setText("")
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/images/icons/help-view.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bInfo.setIcon(icon19)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/images/icons/control.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bPrevious.setIcon(icon20)
        ...
        self.bReset.setText("")
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/images/icons/node-sids-leaf.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bReset.setIcon(icon21)
        ...
        self.bNext.setText("")
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/images/icons/node-sids-closed.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bNext.setIcon(icon22)
    ...
    def retranslateUi(self, Q7VTKWindow):
        ...
        self.bUpdateFromVTK.setToolTip(QtGui.QApplication.translate("Q7VTKWindow", "Reset tree view selection from vtk view", None, QtGui.QApplication.UnicodeUTF8))
        self.bUpdateFromTree.setToolTip(QtGui.QApplication.translate("Q7VTKWindow", "Reset vtk view selection from tree view", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.cShowFamily.setText(QtGui.QApplication.translate("Q7VTKWindow", "Families", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.cShowCT.setText(QtGui.QApplication.translate("Q7VTKWindow", "CTs", None, QtGui.QApplication.UnicodeUTF8))
