...
#
# Created: Thu Apr 14 17:57:24 2016
...
class Ui_Q7VTKWindow(object):
    def setupUi(self, Q7VTKWindow):
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/images/icons/user-U.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Q7VTKWindow):
        ...
        self.bUpdateFromTree.setToolTip(QtGui.QApplication.translate("Q7VTKWindow", "Reset VTK view selection from tree view FIRST selected node", None, QtGui.QApplication.UnicodeUTF8))
        self.bUpdateFromVTK.setToolTip(QtGui.QApplication.translate("Q7VTKWindow", "Reset tree view selection from ALL VTK view selected objects", None, QtGui.QApplication.UnicodeUTF8))
