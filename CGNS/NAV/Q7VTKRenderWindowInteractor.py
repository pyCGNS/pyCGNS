...
# Check whether a specific Q7VTKRenderWindowInteractor base
...
if PyQtImpl == "PyQt6":
    ...
    CursorShape = MouseButton = WindowType = WidgetAttribute = KeyboardModifier = (
        FocusPolicy
    ) = ConnectionType = Key = Qt
...
class Q7VTKRenderWindowInteractor(QVTKRWIBaseClass):
    """A Q7VTKRenderWindowInteractor for Python and Qt.  Uses a
...
def Q7VTKRenderWidgetConeExample():
    """A simple example that uses the Q7VTKRenderWindowInteractor class."""
    ...
    app = QApplication(["Q7VTKRenderWindowInteractor"])
