...
hexas = CGL.newElements(z, 'HEXAS', CGK.HEXA_8_s, NPY.ones((4 * 8), dtype='i'),
...
hexas2 = CGL.newElements(z, 'HEXAS2', CGK.HEXA_8_s, NPY.ones((2 * 8), dtype='i'),
...
(T, b, z) = makeUnstTree(vertexsize, cellsize)
tetras = CGL.newElements(z, 'TETRAS', CGK.TETRA_4_s, NPY.ones((3 * 4), dtype='i'), NPY.array([[1, 3]], 'i', order='F'))
hexas = CGL.newElements(z, 'HEXAS', CGK.HEXA_8_s, NPY.ones((5 * 8), dtype='i'),
