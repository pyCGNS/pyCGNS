...
diag = False
(T, b, z) = makeCorrectTree(vertexsize, cellsize)
tetras = CGL.newElements(z, 'TETRAS', CGK.TETRA_4_s, NPY.ones(((cellsize - 1) * 4), dtype='i'),
...
diag = True
(T, b, z) = makeCorrectTree(vertexsize, cellsize)
hexas = CGL.newElements(z, 'HEXAS', CGK.HEXA_8_s, NPY.ones((cellsize * 8), dtype='i'),
                        NPY.array([[1, cellsize]], 'i', order='F'))
nquads = 3
quads = CGL.newElements(z, 'QUADS', CGK.QUAD_4_s, NPY.ones((nquads * 4), dtype='i'),
...
(T, b, z) = makeCorrectTree(vertexsize, cellsize)
nhexa = 2
hexas = CGL.newElements(z, 'HEXAS', CGK.HEXA_8_s, NPY.ones((nhexa * 8), dtype='i'),
                        NPY.array([[1, nhexa]], 'i', order='F'))
tetras = CGL.newElements(z, 'TETRAS', CGK.TETRA_4_s, NPY.ones(((cellsize - nhexa) * 4), dtype='i'),
