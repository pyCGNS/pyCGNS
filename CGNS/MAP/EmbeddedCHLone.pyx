...
class CHLoneException(Exception):
    mTable = {
        900: 'No such file [{}s]',
        901: 'File already exists [{}s]',
        902: 'File name should be a string',
        903: 'Cannot propagate save to non-existant linked-to file [{}s]',
        904: 'Cannot propagate save to unreadable linked-to file [{}s]',
        905: 'Cannot propagate save to non-existant node in linked-to file [{}s]',
        ...
        909: 'Cannot have attributes {}s at the same time',
        910: 'Keyword argument [{}s] unknown',
